...
const Footer = () => {
  ...
  return (
    <div className="w-full h-auto truncate bg-gray-700">
      <div className="flex flex-col justify-start px-8 md:flex-row 2xl:px-40">
        <div className="flex flex-col w-1/2 gap-5 pt-12 mx-4 text-white">
        ...
        <div className="grid grid-cols-2 gap-5 mx-4 my-8 md:pl-0 lg:grid-cols-3 xl:grid-cols-4 justify-self-center">
      ...
      <div className="flex flex-col px-8 pb-4 md:flex-row 2xl:px-40">
        <div className="flex flex-col w-1/2 gap-5 mx-4 mb-2 text-white md:mb-0 ">
          <div>©2021 WottleNFT</div>
        </div>
        <div className="flex flex-col w-1/2 mx-4 text-white ">
